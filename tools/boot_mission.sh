...
sleep 8
echo "Running full mission..."
ros2 service call /fms/full_mission std_srvs/srv/Trigger 2>&1 | tail -1
for i in $(seq 1 120); do sleep 4; grep -q -E 'full_mission: (COMPLETE|FAILED)' $LOGS/fms.log && break; done
